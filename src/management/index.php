<?php
	...
	$dd = new dd();
	$channelDropdown = $dd->getChannelsDropdown('channelID');
?>
			...
			<script>
				...
				$("#submit").on("click", function(){
					...
					$.ajax({
					    ...
					    data: { 'contentType' : contentType , 'contentLocation' : contentLocation , 'dateStart' : dateStart , 'dateEnd' : dateEnd , 'displayTime' : displayTime , 'addedBy' : addedBy , 'channelID' : channelID },
